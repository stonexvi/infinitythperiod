...
export async function handle(event) {
  ...
  const chatCompletion = await openai.chat.completions.create({
    messages: [
        ...
        { role: 'system', content: 'When you write your script, try to be witty and edgy - the intended audience is college students and adults. It is very important that this new script feels like the previous scripts, and you should make callback references to things that have happened in previous scripts. Do not include an episode number for your script unless it is specifically mentioned in the theme.' },
        { role: 'system', content: 'When you write your script, try to make the subplots for each group of characters very distinct and they do not always get along. Not all characters need to be in every script and not all groups need to be in every script. There should be a central conflict that the characters must overcome using their own agency and this should help them grow as people.' },
        { role: 'system', content: 'Characters can be mean to each other, they are not all friends. Clever jabs are encouraged. Think of this as mature tv.' },
